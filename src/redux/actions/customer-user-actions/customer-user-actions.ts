...
import { FETCH_ALL_PLANTS_CODES, FETCH_ALL_PLANTS_CODES_BY_USER } from "@/redux/reducers/customer-user-reducer/customer-user-reducer";
...
const fetchListAllPlantsCodes = createAsyncThunk(
    ...
    async (
        ...
        const response = await apiGet('/neu-connect/v2/ICustomerFeature/ListAllCustomers', authToken, params);
...
const fetchListAllUserPlantsCodes = createAsyncThunk(
    ...
    async (
        ...
        const response = await apiGet('/neu-connect/v2/ICustomerFeature/GetAllCustomersOfUser', authToken, params);
...
const assignPlantsToUser = createAsyncThunk(
    ...
    async (
        ...
        const response = await apiPost('/neu-connect/v2/ICustomerFeature/AddCustomerToUsers', payload, token);
