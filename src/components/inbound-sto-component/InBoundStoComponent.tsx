...
import BinToBinTransferOrderPostedComponent from './InBoundStoPostedComponent';
import BinToBinTransferOrderUnPostedComponent from './InBoundStoUnPostedComponent';

const InBoundStoComponent = () => {
    ...
    return (
        <Box>
            {/* Header section */}
            <TitleComponent
                title="Inbound Stock Transfer Order"
                description="Confirm transfer orders for inbound stock transfer order."
            />
...
export default memo(InBoundStoComponent);