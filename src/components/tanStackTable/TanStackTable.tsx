...
import { IconArrowNarrowDown, IconArrowNarrowUp, IconArrowsUpDown, IconBorderCorners, IconChevronDown, IconChevronLeft, IconChevronRight, IconColumns, IconFileImport, IconFilter, IconFilterOff, IconSearch, IconSearchOff, IconTrash } from '@tabler/icons-react';
...
import { GlobalSearchFilter2 } from '../table-filters/GlobalSearchFilter2';

const TanStackTable = ({ data, dataCount, columns, isLoading, isInsideModalTable, pagination, setPagination, title, skipRecord, subTitle, isCsvExport, isCheckAll, isUnconfirmedItemIncluded, handleExportToCSV = () => { }, handleDeleteAll = () => { }, handleConfirmAll = () => { }, handlePostAll = () => { }, searchable = false, apiFilter, setApiFilter, filterActive = false, headerTextAllowed = false, isPaginationShown = true }: any) => {
    ...
    const table = useReactTable({
        ...
        state: {
            ...
            globalFilter,
            columnFilters,
            ...(isPaginationShown && { pagination }),
        },
    });

    const baseOptions = [2, 5, 10, 20, 50, 100];
    ...
    return (
        ...
        >
            ...
            >
                ...
                {!searchable && <Group gap="xs" style={{ marginLeft: "auto" }}>
                    <GlobalSearchFilter2
                    ...
                    {/* {(isCheckAll && isUnconfirmedItemIncluded) && <Button
                        variant='transparent'
                        className='filledButton'
                    ...
                    <Group gap="md" align="center">
                        <Group gap="xs" align="center">
                            ...
                            <Select
                                ...
                                data={[
                                    ...baseOptions.map((v) => ({ value: String(v), label: String(v) })),
                                    // ...(dataCount > 100 && !baseOptions.includes(dataCount) && filterActive
                                    ...(dataCount > 100 && !baseOptions.includes(dataCount)
                                        ? [{ value: String(dataCount), label: "All" }]
                                        : []),
                                ]}
                                styles={{
                                    input: {
