...
const TanStackTable2 = ({ data, dataCount, columns, isLoading, isInsideModalTable, pagination, setPagination, title, skipRecord }: any) => {
    ...
    const table = useReactTable({
        ...
        pageCount: Math.ceil(dataCount / pagination.pageSize) || 0,
        state: {
            sorting,
            globalFilter,
            columnFilters,
    ...
    // const memoizedTableOptions = useMemo(
    //     () => ({
    //         data: data || [],
    //         columns: columns || [],
    //         getCoreRowModel: getCoreRowModel(),
    ...
    //         },
    //     }),
    //     [data, columns, dataCount, pagination.pageSize, sorting, globalFilter, columnFilters, pagination]
    // );

    // // ✅ Hook called at top level (safe)
    // const table = useReactTable(memoizedTableOptions);
    ...
    return (
        ...
        >
            ...
            >
                <Stack gap={0}>
                    <Title order={3} mb={8} c={customStyles.colors._4D4D4D} style={{ fontWeight: 600, fontSize: 18 }}>
                        {title}
                    </Title>
                </Stack>
                <Group gap="xs">
            ...
            <Box w="100%" mah={300} className={"custom-scroll"} style={{ overflow: "auto" }}>
                <table
                    style={{
                        width: "100%",
...
export default memo(TanStackTable2)
