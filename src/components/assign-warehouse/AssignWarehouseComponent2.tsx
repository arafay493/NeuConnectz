...
import { assignWareHouseToUser, fetchAllWareHouses, fetchWarehousesListByUserId } from "@/redux/actions/warehouse-actions1/warehouse-actions"
...
const AssignWarehouseComponent = () => {
    ...
    console.log("🚀 ~ AssignWarehouseComponent ~ warehousePermissions:", warehousePermissions)
    ...
    console.log("🚀 ~ AssignWarehouseComponent ~ warehousesListByUserId:", warehousesListByUserId)
    ...
    useEffect(() => {
        if (selectedUser) {
            console.log("🚀 ~ AssignWarehouseComponent ~ warehousesListByUserId:", warehousesListByUserId, warehouses)
            if (warehousesListByUserId && warehousesListByUserId.length > 0) {
                ...
                warehousesListByUserId.forEach(userWarehouse => {
                    // console.log("🚀 ~ AssignWarehouseComponent ~ userWarehouse:", userWarehouse)
                    newPermissions.push({
