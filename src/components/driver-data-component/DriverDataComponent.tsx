...
export const dummyDriverData: DriverDataProps[] = [
    {
        driverName: "John Doe",
        driverLicense: "DL-1234-5678",
        driverContact: "+1 234 567 8901",
        driverAddress: "123 Main Street, New York, USA",
    },
    {
        driverName: "Muhammad Ali",
        driverLicense: "PK-9876-5432",
        driverContact: "+92 300 1234567",
        driverAddress: "Lahore, Punjab, Pakistan",
    },
    {
        driverName: "David Smith",
        driverLicense: "DL-4567-8910",
        driverContact: "+44 7700 900123",
        driverAddress: "London, United Kingdom",
    },
    {
        driverName: "Ahmed Khan",
        driverLicense: "PK-1122-3344",
        driverContact: "+92 321 4455667",
        driverAddress: "Karachi, Sindh, Pakistan",
    },
    {
        driverName: "Chris Evans",
        driverLicense: "DL-7788-9900",
        driverContact: "+1 987 654 3210",
        driverAddress: "Los Angeles, California, USA",
    },
];
...
const DriverDataComponent: FC = () => {
    ...
    const [data, setDriverData] = useState<DriverDataProps[]>(dummyDriverData); // Note: This is the dummy data for vehicle information which can be replaced with actual data from the server.
    ...
    const columns = useMemo<ColumnDef<DriverDataProps>[]>(
        () => [
            ...
            },
            {
                ...
                size: calculateColumnWidth('Driver License', (data || []).map(item => item.driverLicense), 100, 150),
            },
            {
            ...
            },
            {
                ...
                size: calculateColumnWidth('Driver Address', (data || []).map(item => item.driverAddress), 200, 200),
            },
            {
                accessorKey: 'userId',
                header: 'Action',
