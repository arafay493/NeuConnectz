...
import StockTransferPostedComponent from './StockTransferPostedComponent';
import StockTransferUnPostedComponent from './StockTransferUnPostedComponent';

const StockTransferOrderComponent = () => {
    ...
    return (
        <Box>
            ...
            {/* Custom Tab Panels */}
            <div>
                {tab === 'Unposted' && (<StockTransferUnPostedComponent apiUrl={`${process.env.NEXT_PUBLIC_FETCH_ALL_GOOD_ISSUES}?sapStatus=pending` as string} />)}
                {tab === 'Posted' && (<StockTransferPostedComponent apiUrl={`${process.env.NEXT_PUBLIC_FETCH_ALL_GOOD_ISSUES}?sapStatus=Integrated` as string} />)}
            </div>
        </Box>
    );
};

export default memo(StockTransferOrderComponent);