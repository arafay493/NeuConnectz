...
const ReceiptFromProduction: FC<ApiProp> = ({ apiUrl }) => {
  ...
  const { recieptFromProductionList, recieptFromProductionCount } =
    ...
    () => [
      ...
      },
      {
        ...
        size: calculateColumnWidth(
          "Doc No",
          (recieptFromProductionList || []).map((item) =>
      ...
      },
      {
        ...
        size: calculateColumnWidth(
          "Item Code",
          (recieptFromProductionList || []).map((item) => item.itemCode),
          150,
          220
        ),
      },
      ...
      },
      {
        ...
        size: calculateColumnWidth(
          "WHS",
          (recieptFromProductionList || []).map((item) => item.wareHouseCode),
          150,
          220
        ),
      },
          ...
          <Group gap="md" align="center">
            ...
            <Text size="sm" c={customStyles.colors._909090}>
              ...
              {Math.min(
                ...
                recieptFromProductionCount
              )}{" "}
              of {recieptFromProductionCount} entries
            </Text>
          </Group>
        </Group>
      </Box>
