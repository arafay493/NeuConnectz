...
import SalesOrderFilterBar from './SalesOrderFilterBar';
        ...
        <Box p={8}>
            <Group justify="space-between" align="center" style={{ flexShrink: 0, marginBottom: '16px' }}>
                ...
                <Button
                    ...
                    size="md"
                    radius={8}
                    onClick={() => router.push(routes.addSaleOrder)}
                >
                    Add Sale Order
                </Button>
            </Group>
...
export default memo(SalesOrderComponent);