...
import { fetchAllGoodsIssue } from '@/redux/actions/gi-actions/gi-actions';
...
const GoodsIssuePosted: FC<ApiProp> = ({ apiUrl }) => {
    ...
    const columns = useMemo<ColumnDef<GoodsIssueDataType>[]>(
        () => [
            {
            ...
            },
            {
                ...
                enableColumnFilter: true,
                size: calculateColumnWidth('Doc No', (listGoodIssue || []).map(item => String(item.docNum)), 150, 220),
            },
            {
                ...
                filterFn: stringFilterFn,
                enableColumnFilter: true,
                size: calculateColumnWidth('Item Code', (listGoodIssue || []).map(item => item.itemCode), 150, 220),
            },
            {
