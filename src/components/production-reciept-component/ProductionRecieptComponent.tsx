...
import ProductionRecieptUnPostedComponent from './ProductionRecieptUnPostedComponent';
import ProductionRecieptPostedComponent from './ProductionRecieptPostedComponent';

const ProductionRecieptComponent = () => {
    ...
    return (
        <Box>
            {/* Header section */}
            <TitleComponent
                title="Production Reciept"
                description="Confirm transfer orders for production receipt."
            />
            ...
            {/* Custom Tab Panels */}
            <div>
                {tab === 'Unposted' && (<ProductionRecieptUnPostedComponent apiUrl={`/IProductionReceiptFeature/GetProductionReceiptsList?sapStatus=Pending` as string} />)}
                {tab === 'Posted' && (<ProductionRecieptPostedComponent apiUrl={`/IProductionReceiptFeature/GetProductionReceiptsList?sapStatus=Integrated` as string} />)}
            </div>
        </Box>
    );
};

export default memo(ProductionRecieptComponent);