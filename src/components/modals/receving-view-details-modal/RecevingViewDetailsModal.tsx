...
import RFP_Columns from "@/components/columns/RFP_Columns";
...
export default function RecievingViewDetailsModal({
    opened,
    handleModalClose,
    row,
    isLoading,
    ...
    const columns = RFP_Columns({ pagination, listAgainstPo })
