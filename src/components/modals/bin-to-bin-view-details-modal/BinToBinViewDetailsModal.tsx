...
import BinToBin_View_Columns from "@/components/columns/BinToBin_View_Columns";
...
export default function BinToBinViewDetailsModal({
    opened,
    handleModalClose,
    row,
    isLoading,
    ...
    const { ListAllBinToBinViewDetailsData } = useAppSelector(({ binToBinStates }) => { return binToBinStates });
    ...
    const columns = BinToBin_View_Columns({ pagination, list: ListAllBinToBinViewDetailsData?.data, actions: {} })
    ...
    return (
        ...
        >
            ...
            <TanStackTable
                data={Array.isArray(ListAllBinToBinViewDetailsData?.data) ? ListAllBinToBinViewDetailsData?.data : []}
                dataCount={ListAllBinToBinViewDetailsData?.totalCount}
                columns={columns}
                isLoading={isLoading}
