...
export default function ProductionRecieptViewDetailsModal({
    opened,
    handleModalClose,
    row,
    isLoading,
    ...
    const { ListAllProductionRecieptViewDetailsData } = useAppSelector(({ productionRecieptStates }) => { return productionRecieptStates });
        ...
        >
            ...
            <Box mb="md">
                <SimpleGrid cols={{ base: 1, sm: 2, md: 4 }} spacing="md" verticalSpacing="sm">
                    ...
                    <InfoRow label="TR Number" value={row?.trNumber || "-"} />
                    <InfoRow label="Material Document" value={row?.materialDocument || "-"} />
            ...
            <TanStackTable
                data={Array.isArray(ListAllProductionRecieptViewDetailsData?.data) ? ListAllProductionRecieptViewDetailsData?.data : []}
                dataCount={ListAllProductionRecieptViewDetailsData?.totalCount}
                columns={columns}
                isLoading={isLoading}
