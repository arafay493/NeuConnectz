...
const DashboardUnPostedDocuments = () => {
    ...
    const unPostedDocumentCard = [
        {
            title: 'ITR',
            icon: <IconPackages color={customStyles.colors.white} size={24} />,
            color: '#789EFF',
            value: dashboardAnalyticsData?.transferStatistics?.totalItrPending || 0,
            subValue: '/54',
            percentage: '+19.01%',
            bgColor: '#E8F0FF'
        },
        {
            ...
            color: '#D5A5FF',
            value: dashboardAnalyticsData?.transferStatistics?.totalItPending || 0,
            subValue: '/0',
            percentage: '+19.01%',
            bgColor: '#F5EBFF'
        },
        {
            ...
            color: '#FF8A8A',
            value: dashboardAnalyticsData?.transferStatistics?.totalTrPending || 0,
            subValue: '/2',
            percentage: '+19.01%',
            bgColor: '#FFE8E8'
        },
        {
            ...
            color: '#FFA261',
            value: dashboardAnalyticsData?.grnStatistics?.totalGrnPending || 0,
            subValue: '/52',
            percentage: '+19.01%',
            bgColor: '#FFF0E6'
        }
    ...
    return (
        <Stack bg={customStyles.colors.white} p={24} gap={24} style={{ borderRadius: 16 }}>
            ...
            <Group justify="space-between" align="center" style={{ flexShrink: 0 }}>
                <Title order={4} c={customStyles.colors._4D4D4D} fw={600}>Unposted Documents</Title>
                {/* <Group gap={12}>
                    <Select
                        w={150}
            ...
            <Grid>
                {
                    unPostedDocumentCard.map((card, index) => (
...
export default DashboardUnPostedDocuments