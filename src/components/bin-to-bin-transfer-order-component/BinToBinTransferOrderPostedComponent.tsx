...
import { fetchListAllOutbounds, fetchListAllBinToBin, fetchListAllSalesOrder } from '@/redux/actions/bin-to-bin-actions/bin-to-bin-actions';
...
import BinToBinTransferOrderPosted_Columns from '../columns/BinToBinTransferOrderPosted_Columns';
...
const BinToBinTransferOrderPostedComponent: FC<ApiProp> = ({ apiUrl, reservationApiUrl, outboundApiUrl, salesOrderApiUrl }) => {
...
export default memo(BinToBinTransferOrderPostedComponent);