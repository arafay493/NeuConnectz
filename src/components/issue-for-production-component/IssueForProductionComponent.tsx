...
const IssueForProductionComponent: FC<ApiProp> = ({ apiUrl }) => {
  ...
  const { issuesForProductionList, issuesForProductionCount } = useAppSelector(
    ({ sapStates }) => {
      return sapStates;
    }
  );
    ...
    () => [
      ...
      },
      {
        ...
        size: calculateColumnWidth(
          "Doc No",
          (issuesForProductionList || []).map((item) =>
      ...
      },
      {
        ...
        size: calculateColumnWidth(
          "Item Code",
          (issuesForProductionList || []).map((item) => item.itemCode),
          150,
          220
        ),
      },
      ...
      },
      {
        ...
        size: calculateColumnWidth(
          "Quantity",
          (issuesForProductionList || []).map((item) => String(item.quantity)),
          120,
          150
        ),
      },
      {
        ...
        size: calculateColumnWidth(
          "Warehouse",
          (issuesForProductionList || []).map((item) => item.wareHouseCode),
          150,
          220
        ),
      },
          ...
          <Group gap="md" align="center">
            ...
            <Text size="sm" c={customStyles.colors._909090}>
              ...
              {Math.min(
                ...
                issuesForProductionCount
              )}{" "}
              of {issuesForProductionCount} entries
            </Text>
          </Group>
        </Group>
      </Box>
