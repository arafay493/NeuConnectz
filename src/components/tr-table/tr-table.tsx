...
const TR_TableCom: React.FC<ApiProp> = ({ apiUrl }) => {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, columnId, value) => {
            ...
            const columnIds = ['docNum', 'fromWareHouseCode', 'toWareHouseCode', 'docStatus', 'itemCode', 'itemName', 'quantity', 'erpDocEntry', 'erpObjectType', 'erpDocLine', 'sapStatus'];
            return columnIds.some((colId: string) => globalFilterFn(row, colId, value));
        },
        onPaginationChange: setPagination,
        manualPagination: true, // Enable server-side pagination
        pageCount: Math.ceil(trDataCount / pagination.pageSize), // Calculate total pages from server data
        state: {
            sorting,
            globalFilter,
            columnFilters,
            ...
            <Stack p={24} mt={24} bg={customStyles.colors.white} style={{ borderRadius: '16px', width: '100%' }}>
                ...
                <Group mb={24} justify="space-between" align="center" style={{ flexShrink: 0 }}>
                    <Stack gap={0}>
                        ...
                        <Text c={customStyles.colors._909090} style={{ fontWeight: 500, fontSize: 16 }}>View, search, and manage all TR data by using multiple filters.</Text>
                    </Stack>
                    <Group gap="xs">
                        <GlobalSearchFilter
            ...
            >
                <Group justify="space-between" align="center">
                    ...
                    <Group gap="md" align="center">
                        ...
                        <Text size="sm" c={customStyles.colors._909090}>
                            Showing {skipRecord + 1} to {Math.min(skipRecord + pagination.pageSize, trDataCount)} of {trDataCount} entries
                        </Text>
                    </Group>
                </Group>
            </Box>
